...
(function(t, e) {
	...
	t.widget("ui.autocomplete", {
		...
		_setOption: function(t, e) {
			this._super(t, e), "source1" === t && this._initSource(), "appendTo" === t && this.menu.element.appendTo(this._appendTo()), "disabled" === t && e && this.xhr && this.xhr.abort()
		},
		_appendTo: function() {
		...
		_initSource: function() {
			var e, i, s = this;
			t.isArray(this.options.source1) ? (e = this.options.source1, this.source1 = function(i, s) {
				s(t.ui.autocomplete.filter(e, i.term))
			}) : "string" == typeof this.options.source1 ? (i = this.options.source1, this.source1 = function(e, n) {
			...
			}) : this.source1 = this.options.source1
		},
		...
		_search: function(t) {
			this.pending++, this.element.addClass("ui-autocomplete-loading"), this.cancelSearch = !1, this.source1({
				term: t
			}, this._response())
		},
		_response: function() {
