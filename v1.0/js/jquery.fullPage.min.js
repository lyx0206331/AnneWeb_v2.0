/**! jQuery canjian 2015-06-03 **/
(function(b) {
	b.fullpage = function(c) {
		function m(a) {
			if (c.autoScrolling) {
				a = window.event || a;
				...
				var e;
				e = b(".section.active");
				if (!k) if (e = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") : e.find(".scrollable"), 0 > a) if (0 < e.length) if (v("bottom", e)) b.fullpage.moveSectionDown();
				else return !0;
				else b.fullpage.moveSectionDown();
				else if (0 < e.length) if (v("top", e)) b.fullpage.moveSectionUp();
				else return !0;
				else b.fullpage.moveSectionUp();
				return !1
			}
		}
		function F() {
		...
		var J = 700;
		b.fullpage.setAutoScrolling = function(a) {
			c.autoScrolling = a;
			a = b(".section.active");
		...
		b(".section").each(function(a) {
			...
			b.fullpage.setAutoScrolling(c.autoScrolling);
		...
		b(document).on("touchmove", function(a) {
			if (c.autoScrolling && B) {
				...
				else if (a = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") : e.find(".scrollable"), D > E) if (0 < a.length) if (v("bottom", a)) b.fullpage.moveSectionDown();
				else return !0;
				else b.fullpage.moveSectionDown();
				else if (0 < a.length) if (v("top", a)) b.fullpage.moveSectionUp();
				else return !0;
				else b.fullpage.moveSectionUp()
			}
		});
		...
		b(document).keydown(function(a) {
			...
			case 38:
			case 33:
				b.fullpage.moveSectionUp();
				break;
			case 40:
			case 34:
				b.fullpage.moveSectionDown();
				break;
			case 37:
